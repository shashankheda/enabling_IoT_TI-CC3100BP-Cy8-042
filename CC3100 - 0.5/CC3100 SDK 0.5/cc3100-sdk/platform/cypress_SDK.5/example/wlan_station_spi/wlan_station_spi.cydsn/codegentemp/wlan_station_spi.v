// ======================================================================
// wlan_station_spi.v generated from TopDesign_UART.cysch
// 07/03/2014 at 18:56
...
module SCB_P4_v1_20_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("228e7cd3-8c0d-4500-b7f0-e113ebf20bbc/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("228e7cd3-8c0d-4500-b7f0-e113ebf20bbc/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// UART_v2_30(Address1=0, Address2=0, BaudRate=115200, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, CtrlModeReplacementString=SyncCtl, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=1, HalfDuplexEn=false, HwTXEnSignal=false, InternalClock=true, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=true, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=921600, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_COMPONENT_NAME=UART_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=UARTM, CY_INSTANCE_SHORT_NAME=UARTM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=UARTM, )
module UART_v2_30_1 (
    rx_clk,
    rx_data,
    tx_clk,
...
module top ;
	...
	wire [0:0] tmpOE__nHIB_net;
	wire [0:0] tmpFB_0__nHIB_net;
	wire [0:0] tmpIO_0__nHIB_net;
	wire [0:0] tmpINTERRUPT_0__nHIB_net;
	electrical [0:0] tmpSIOVREF__nHIB_net;

	cy_psoc3_pins_v1_10
		#(.id("ff5e7e0a-f582-438c-9e5d-afd701a89f56"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		nHIB
		 (.oe(tmpOE__nHIB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__nHIB_net[0:0]}),
		  .io({tmpIO_0__nHIB_net[0:0]}),
		  .siovref(tmpSIOVREF__nHIB_net),
		  .interrupt({tmpINTERRUPT_0__nHIB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__nHIB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("bb8d5373-20e6-45f0-aad1-dcf41536ccd6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_30_1 UARTM (
        ...
        .rx_data(Net_10),
        .rx_clk(Net_11));
    defparam UARTM.Address1 = 0;
    defparam UARTM.Address2 = 0;
    defparam UARTM.EnIntRXInterrupt = 0;
    defparam UARTM.EnIntTXInterrupt = 0;
    defparam UARTM.FlowControl = 1;
    defparam UARTM.HalfDuplexEn = 0;
    defparam UARTM.HwTXEnSignal = 0;
    defparam UARTM.NumDataBits = 8;
    defparam UARTM.NumStopBits = 1;
    defparam UARTM.ParityType = 0;
    defparam UARTM.RXEnable = 1;
    defparam UARTM.TXEnable = 1;

	wire [0:0] tmpOE__m_rx_pin_net;
	wire [0:0] tmpIO_0__m_rx_pin_net;
	wire [0:0] tmpINTERRUPT_0__m_rx_pin_net;
	electrical [0:0] tmpSIOVREF__m_rx_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .width(1))
		m_rx_pin
		 (.oe(tmpOE__m_rx_pin_net),
		  .y({1'b0}),
		  .fb({Net_82}),
		  .io({tmpIO_0__m_rx_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__m_rx_pin_net),
		  .interrupt({tmpINTERRUPT_0__m_rx_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__m_rx_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__m_tx_pin_net;
	wire [0:0] tmpFB_0__m_tx_pin_net;
	wire [0:0] tmpIO_0__m_tx_pin_net;
	wire [0:0] tmpINTERRUPT_0__m_tx_pin_net;
	electrical [0:0] tmpSIOVREF__m_tx_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("ca6156c3-5808-49f6-a07d-a71b7dc971e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .width(1))
		m_tx_pin
		 (.oe(tmpOE__m_tx_pin_net),
		  .y({Net_103}),
		  .fb({tmpFB_0__m_tx_pin_net[0:0]}),
		  .io({tmpIO_0__m_tx_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__m_tx_pin_net),
		  .interrupt({tmpINTERRUPT_0__m_tx_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__m_tx_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__m_cts_pin_net;
	wire [0:0] tmpIO_0__m_cts_pin_net;
	wire [0:0] tmpINTERRUPT_0__m_cts_pin_net;
	electrical [0:0] tmpSIOVREF__m_cts_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("e8322fbe-de5f-4987-b5b1-94235d10a818"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .width(1))
		m_cts_pin
		 (.oe(tmpOE__m_cts_pin_net),
		  .y({1'b0}),
		  .fb({Net_91}),
		  .io({tmpIO_0__m_cts_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__m_cts_pin_net),
		  .interrupt({tmpINTERRUPT_0__m_cts_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__m_cts_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__m_rts_pin_net;
	wire [0:0] tmpFB_0__m_rts_pin_net;
	wire [0:0] tmpIO_0__m_rts_pin_net;
	wire [0:0] tmpINTERRUPT_0__m_rts_pin_net;
	electrical [0:0] tmpSIOVREF__m_rts_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("1f6e59c5-4349-4574-8952-788d3d37ded7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .width(1))
		m_rts_pin
		 (.oe(tmpOE__m_rts_pin_net),
		  .y({Net_4}),
		  .fb({tmpFB_0__m_rts_pin_net[0:0]}),
		  .io({tmpIO_0__m_rts_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__m_rts_pin_net),
		  .interrupt({tmpINTERRUPT_0__m_rts_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__m_rts_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
