// ======================================================================
// spi_debug_tool.v generated from TopDesign.cysch
// 07/03/2014 at 14:06
...
module top ;
	...
	wire [0:0] tmpOE__IRQ_Pin_net;
	wire [0:0] tmpFB_0__IRQ_Pin_net;
	wire [0:0] tmpIO_0__IRQ_Pin_net;
	electrical [0:0] tmpSIOVREF__IRQ_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("15164174-a11a-440a-a032-290925a665aa"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .width(1))
		IRQ_Pin
		 (.oe(tmpOE__IRQ_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IRQ_Pin_net[0:0]}),
		  .io({tmpIO_0__IRQ_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__IRQ_Pin_net),
		  .interrupt({Net_110}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__IRQ_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("10021fa8-8bb1-4d97-8f77-7e0781317e28"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
